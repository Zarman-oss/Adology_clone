    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col lg:flex-row items-center justify-center gap-12'>
      ...
      <div className='w-full lg:w-1/2 relative z-10'>
        ...
        <div className='flex flex-col gap-6'>
          <div>
            <h1 className='heading-1-medium text-white'>Create An Account</h1>
          ...
          <form className='flex flex-col gap-4'>
            ...
            <label className='flex items-center gap-3 mt-2 text-white'>
              <input
                type='checkbox'
                id='terms'
                name='terms'
                className='w-5 h-5 accent-white checked:bg-zinc-500 outline-[1.50px] outline-offset-[-0.75px] outline-zinc-500'
              />
              <span className='body-1-regular'>
                Yes, I agree to Adology's Terms of Service
              </span>
            </label>
          </form>
