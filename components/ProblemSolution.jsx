...
export default function ProblemSolution() {
  return (
    <section className='mt-24 flex flex-col items-center gap-8 mx-auto'>
      <PrimaryButton text='Problem' />
      <article className='flex flex-col items-center'>
        <h2 className='heading-3-medium capitalize text-white'>
          How It Works: The AI Workflow
        </h2>
        <p className='heading-4-regular text-white'>
      ...
      <article className='flex flex-col items-center'>
        ...
        <ul className='heading-4-regular text-white list-disc'>
      ...
      {/* Feature cards */}
      {/* feature container */}
      <div className='max-w-[800px] mx-auto w-full flex flex-wrap items-center justify-center gap-4'>
        {/* Card */}
        <div className='flex flex-col gap-4 p-4 items-center max-w-[370px]'>
          ...
          <h2 className='heading-5-medium text-white'>AI-Enhanced Reporting</h2>
